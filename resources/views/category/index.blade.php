                                ...
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    @if (!$category->deleted_at)
                                        <form action="{{ route('admin.category.destroy', $category->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger btn-sm btn-delete btn-delete-category" type="button">
                                    ...
                                    @else
                                        ...
                                        <form action="{{ route('admin.category.force-destroy', $category->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger btn-sm btn-delete btn-force-delete-category" type="button">
