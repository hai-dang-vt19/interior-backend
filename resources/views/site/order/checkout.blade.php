    ...
    <section class="ck-page">
        <header class="ck-head mb-4">
            <p class="ck-breadcrumb mb-1">
                <a href="{{ route('site.cart.index') }}">Gio hang</a>
                <span>/</span>
            ...
            <div class="col-lg-7">
                <div class="ck-card">
                    <div class="ck-card-head">
                        <h5 class="mb-0">Thong tin giao hang</h5>
                    </div>
                    <div class="ck-card-body">
                        <form action="{{ route('site.checkout.submit') }}" method="POST" class="ck-form">
                            ...
                            <button type="submit" class="btn btn-success ck-submit-btn">Dat hang</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <aside class="ck-summary-card">
                    <div class="ck-summary-head">
                        <h5 class="mb-0">Tom tat don hang</h5>
                        ...
                        @foreach (($checkoutItems ?? $cart->items) as $item)
                            ...
                            <li class="ck-summary-item">
                                ...
                                <div class="ck-summary-main">
                                    ...
                                    <small class="text-muted">So luong: {{ (int) $item->quantity }}</small>
                                </div>
